 ...
 * @version 1.0.0
 */
var ErrorSchema = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ErrorSchema</code>.
   * @alias module:model/ErrorSchema
   * @param message {String} 
   */
  function ErrorSchema(message) {
    _classCallCheck(this, ErrorSchema);

    ErrorSchema.initialize(this, message);
  }
  /**
