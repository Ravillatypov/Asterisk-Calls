...
var _InlineResponse200Result = _interopRequireDefault(require("./InlineResponse200Result"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('result')) {
          obj['result'] = _InlineResponse200Result["default"].constructFromObject(data['result']);
        }
      }
